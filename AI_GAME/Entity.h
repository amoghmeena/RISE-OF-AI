...
enum AIType { WALKER, GUARD, FYLER };  
...
private:
    ...
    int m_walking[2][8]; // now a 2x8 array for walking animations
...
public:
    ...
    // ————— METHODS ————— //
    Entity();
    Entity(GLuint texture_id, float speed, glm::vec3 acceleration, float jump_power, int walking[2][8], float animation_time,
    ...
    void ai_fly(Entity* player);  // Added: new FYLER AI method
